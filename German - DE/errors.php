...
//BASIC ERRORS
"ERROR_NOCOMP"               => "Sie haben keine Firma. Erstelle zuerst eine!",
"ERROR_NOCOMP2"              => "Sie haben keine Firma.",
"ERROR_NOMONEY"              => "Ihr Unternehmen hat nicht genug Geld!",
...
"ERROR_INVALID_COUNTRY"      => "Ungültige Land!",
"ERROR_INVALID_OBJECT"       => "Ungültige Objekt!",
"ERROR_LEVEL_TOO_LOW"        => "Du hast nicht das benötigte Level!",
"ERROR_SELECTED"             => "Ausgewählt.",
"ERROR_INVALID_MEMBER"       => "Mitglid existiert nicht!",
...
"ERROR_PAYMENT_EXP"              => "Zahlung abgelaufen, versuche es erneut.",
"ERROR_PAYMENT_CANCELLED"        => "Bezahlung abgebrochen.",
"ERROR_PAYMENT_NOT_ACCEPTED"     => "Zahlung nicht akzeptiert.",
"ERROR_PREMIUM_BOUGHT"           => "Premium funktion freigeschaltet.",
"ERROR_NOT_ENOUGH_CREDITS"       => "Du hast nicht genug Premium Credits, kaufe dir erst welche!",
"ERROR_PREMIUM_REQ"              => "Du benötigst ein Premium Account für diese Funktion.",

//Video Reward
"ERROR_REWARD_CLAIMED"           => "Belohnung beansprucht!",
"ERROR_DAY_LIMIT_REACHED"        => "Tageslimit erreicht!",
...
//User
    ...
    "ERROR_BLACKLISTED"          => "Sie wurden von diesem Mitglied auf die schwarze Liste gesetzt!",
    ...
    "ERROR_MSG_NO_SUBJECT"       => "Kein Betreff angegeben!",
    "ERROR_MSG_NO_RECEIVER"      => "Kein Empfänger angegeben!",
    "ERROR_MSG_NO_CONTENT"       => "Kein Inhalt angegeben!",

    //Profile
    "ERROR_CURRENT_PASSWORD"     => "Sie müssen Ihr aktuelles Passwort eingeben!",
    "ERROR_NEW_PASSWORD"         => "Gibt ein neues Passwort ein!",
    "ERROR_PASSWORD_CHANGED"     => "Passwort geändert!",
    "ERROR_DATABASE_ERROR"       => "Datenbank fehler!",
    "ERROR_PASS_NOT_SAFE"        => "Neues Passwort ist nicht sicher genug! Das Passwort sollte mindestens 6 Zeichen lang sein und eine Ziffer und einen Großbuchstaben enthalten.",
    "ERROR_PASS_INCORRECT"       => "Falsches Passwort!",
...
//Company + Corporation
    ...
    //General
    "ERROR_NAME_EXISTS"          => "Name bereits vorhanden!",
    "ERROR_NAME_SHORT"           => "Name ist zu kurz! Mindestens 6 Zeichen!",
    "ERROR_NAME_SHORT2"          => "Name ist zu kurz! Mindestens 3 Zeichen!",
    "ERROR_NAME_LONG"            => "Name ist zu lang! Maximum 18 Zeichen!",
    "ERROR_NAME_LONG2"           => "Name ist zu lang! Maximum 13 Zeichen!",
    "ERROR_NO_WAREHOUSE"         => "Du hast kein Warenhaus! Kauf zuerst eins im Shop!",


    //Freights
    "ERROR_SPECIFY_FREIGHT"      => "Bitte geben Sie die Fracht an, die Sie annehmen möchten.",
    "ERROR_INVALID_FREIGHT"      => "Diese Frachtnummer ist nicht gültig.",
    "ERROR_INVALID_TR_LICENSE"   => "Sie haben keine gültige Transportlizenz für diese Frachtart.",
    "ERROR_WAREHOUSE_FULL"       => "Ihr Lager ist zu klein. Aktualisieren Sie es oder stornieren Sie andere Frachten zuerst!",
    "ERROR_INV_OR_ACC_FREIGHT"   => "Diese Fracht ist ungültig oder wurde von einer anderen Person bereits akzeptiert.",
    "ERROR_FREIGHT_ACCEPTED"     => "Sie haben diese Fracht akzeptiert.",
...
//Company
    ...
    "ERROR_HQ_PART_CONCERN"          => "Der Hauptsitz kann nur geändert werden, wenn Ihr Unternehmen nicht Teil einer Konzern ist.",
    "ERROR_HQ_CHANGE_DAYS"           => "Das Hauptquartier kann nur einmal alle 7 Tage geändert werden.",
    "ERROR_HQ_CHANGED"               => "Der Firmensitz wurde geändert.",
    "ERROR_MONEY_TRANSFERED"         => "Geld erfolgreich überwiesen!",
    "ERROR_LEVEL_BANK_ACC"           => "Sie müssen auf Level 7 sein, um ein Sparkonto zu eröffnen!",
    "ERROR_NOMONEY_SAVINGS"          => "Sie haben nicht genug Geld auf Ihrem Sparkonto!",
    "ERROR_NOBANKACC"                => "Sie haben kein Sparkonto! Fordern Sie zuerst eines im Shop an!",
    "ERROR_COMPMADE"                 => "Die Firma wurde erstellt",
    "ERROR_ALREADY_COMP"             => "Sie haben bereits eine Firma!",
